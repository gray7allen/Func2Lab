...
let multiply = (num1, num2, callbackFunc) => callbackFunc(num1 * num2)
...
let first = (arr, callbackFunc) => callbackFunc(arr[0])
...
let last = (arr, callbackFunc) => callbackFunc(arr[arr.length - 1])
...
let each = (arr, callbackFunc) => arr.forEach((nameArr, i) => callbackFunc(nameArr, i))
